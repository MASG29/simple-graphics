...
public class Canvas {
    ...
    /**
     * Returns the singleton canvas of the Canvas.
     *
    ...
    public static void snapshot() {
        Dimension dim = getCanvas().component.getPreferredSize();
        ...
        getCanvas().component.paintComponent(g);
        ...
        getCanvas().background = filteredImage;
        getCanvas().component.repaint();
    }
